...
import com.yygh.hospital.mapper.OrderInfoMapper;
import com.yygh.hospital.mapper.ScheduleMapper;
import com.yygh.hospital.model.OrderInfo;
import com.yygh.hospital.model.Patient;
import com.yygh.hospital.model.Schedule;
import com.yygh.hospital.config.HospitalRabbitConfig;
...
/**
 * 医院服务实现类，处理预约下单、支付状态更新、取消预约等业务逻辑
 *
 * @author XXJ
 */
...
public class HospitalServiceImpl implements HospitalService {
    ...
    public void updatePayStatus(Map<String, Object> paramMap) {
        ...
        statusMsg.put("hosRecordId", orderInfo.getId().toString());
        statusMsg.put("orderStatus", 1);
        rabbitTemplate.convertAndSend(HospitalRabbitConfig.ORDER_EXCHANGE, HospitalRabbitConfig.ORDER_ROUTING_KEY, statusMsg);
    }
